...
| --- | --- | --- |
| [2.1.3](/releases/v2.1.3) | 2026.07.05 | WeChat group channel login-state fixes, QR status reporting, manual group-scope handling, image understanding, image-generation routing, custom provider cleanup, and diagnostics |
