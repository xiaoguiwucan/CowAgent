const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    wechat_group_scan_title: '个人微信群扫码登录',
    wechat_group_scan_desc: '使用微信扫描下方二维码登录个人微信群通道',
    wechat_group_scan_loading: '正在启动微信群通道...',
    wechat_group_scan_waiting: '等待扫码',
    wechat_group_scan_success: '微信群通道已连接',
    wechat_group_scan_fail: '启动微信群通道失败',
    wechat_group_qr_tip: '扫码后将在群聊中响应 @ 消息',
    wechat_group_rooms_title: '目标群',
    wechat_group_rooms_hint: '优先按 room ID 精确限制，群名只作为兜底。',
    wechat_group_rooms_refresh: '刷新',
    wechat_group_rooms_refreshed: '群列表已刷新',
    wechat_group_rooms_refresh_failed: '刷新群列表失败',
    wechat_group_rooms_empty: '登录后刷新群列表，或先在下方填写群名兜底。',
  ...
  en: {
    ...
    wechat_group_scan_title: 'WeChat Groups QR Login',
    wechat_group_scan_desc: 'Scan the QR code below with WeChat to connect the group channel',
    wechat_group_scan_loading: 'Starting WeChat group channel...',
    wechat_group_scan_waiting: 'Waiting for scan',
    wechat_group_scan_success: 'WeChat group channel connected',
    wechat_group_scan_fail: 'Failed to start WeChat group channel',
    wechat_group_qr_tip: 'After login, the channel replies to @ messages in groups',
    wechat_group_rooms_title: 'Target groups',
    wechat_group_rooms_hint: 'Room IDs are preferred; names are fallback matching.',
    wechat_group_rooms_refresh: 'Refresh',
    wechat_group_rooms_refreshed: 'Group list refreshed',
    wechat_group_rooms_refresh_failed: 'Failed to refresh groups',
    wechat_group_rooms_empty: 'Refresh after login, or enter fallback group names below.',
    ...
    groups_status_idle: 'Waiting for channel status',
